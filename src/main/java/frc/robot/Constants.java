...
public class Constants {
    ...
    public static final double BONUS_OUT = 0.25;
    ...
    public static final SparkMaxConstants DRIVEL2_CONSTANTS = new SparkMaxConstants(1e-4, 0, 0, 0, 0.000156, -1, 1, 0, 0, 6000, 3500, 0.1);
    public static final SparkMaxConstants DRIVER2_CONSTANTS = new SparkMaxConstants(1e-4, 0, 0, 0, 0.000156, -1, 1, 0, 0, 6000, 3500, 0.1);

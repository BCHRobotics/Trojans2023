...
public final class Constants {
  ...
  public static final class Chassis {
    ...
    public static final double LEFT_POSITION_CONVERSION = 70.5 / 33.35684585571289; // inches per revolutions
    public static final double RIGHT_POSITION_CONVERSION = 70.5 / 33.904457092285156; // #inches / #revs

    public static final double LEFT_VELOCITY_CONVERSION = LEFT_POSITION_CONVERSION / 60; // inches per second
    public static final double RIGHT_VELOCITY_CONVERSION = RIGHT_POSITION_CONVERSION / 60; // #inches / 1 sec

    public static final double MAX_VELOCITY = 144; // in/s
    public static final double MAX_ACCELERATION = 288; // in/s^2

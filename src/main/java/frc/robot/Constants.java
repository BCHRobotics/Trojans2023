...
public class Constants {
        ...
        public static final double limelightHeight = -1; //placeholder until mechanical agrees on where to mount limelight
        public static final double limelightIndent = -1; //distance(positive) of limelight from front of bot
